...
const colorTokens = {
  ...
  items: [
    {name: 'Highlight', value: colorShades.base},
    {name: 'Dark', value: colorShades.dark},
    {name: 'Light', value: colorShades.light},
    {name: 'Glare', value: colorShades.glare},
    {name: 'Shade', value: colorShades.shade},
    {name: 'Desaturated', value: colorShades.desaturate}
  ]
};
